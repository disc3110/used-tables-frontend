          ...
          <article className="rounded-[2rem] border border-[#e3d5c2] bg-[#fffdfa] p-7 shadow-[0_22px_46px_rgba(47,35,22,0.08)] md:p-8">
            ...
            >
              <label className="flex flex-col gap-2">
                ...
                <input
                  type="text"
                  className="rounded-[1rem] border border-[#ded1bf] bg-[#fcfaf6] px-4 py-3.5 text-[#122233] outline-none transition focus:border-[#c89f57]"
                />
              </label>

              <label className="flex flex-col gap-2">
                <span className="text-sm font-medium text-[#132334]">Email Address</span>
                <input
                  type="email"
                  className="rounded-[1rem] border border-[#ded1bf] bg-[#fcfaf6] px-4 py-3.5 text-[#122233] outline-none transition focus:border-[#c89f57]"
                />
              ...
              <label className="flex flex-col gap-2">
                ...
                <select className="rounded-[1rem] border border-[#ded1bf] bg-[#fcfaf6] px-4 py-3.5 text-[#122233] outline-none transition focus:border-[#c89f57]">
              ...
              <div className="md:col-span-2 flex flex-col gap-4 pt-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  {submitted ? (
                    <p className="mt-3 text-sm text-[#6d7a48]">
